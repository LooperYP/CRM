									...
									<TD>
										<TABLE id=table_1 style="DISPLAY: none" cellSpacing=0
											...
											<TBODY>
												...
												<TR> 
													<TD class=menuSmall><A class=style2 href="${pageContext.request.contextPath }/customer_findCustomerList.action"
								...
								<TR>
									<TD>
										<TABLE id=table_2 style="DISPLAY: none" cellSpacing=0
											...
											<TBODY>
												<TR>
													<TD class=menuSmall><A class=style2 href="linkman_showAdd.action"
														target=main>－ 新增联系人</A></TD>
												</TR>
												<TR>
													<TD class=menuSmall><A class=style2 href="linkman_findLinkManList.action"
									...
									<TD>
										<TABLE id=table_5 style="DISPLAY: none" cellSpacing=0
											...
											<TBODY>
												<TR>
													<TD class=menuSmall>
														<s:a action="saleVisit_showAdd" namespace="/" target="main" cssClass="style2">－新增客户拜访</s:a>
													</TD>
												</TR>
												<TR>
													<TD class=menuSmall>
														<s:a action="saleVisit_findSaleVisitList" namespace="/" target="main" cssClass="style2">－客户拜访列表</s:a>
													</TD>
												</TR>
