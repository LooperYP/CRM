...
<SCRIPT language=javascript>
	...
	$(function() {
		$(".confirmDel").click(function(even) {
		...
		/* $.post(
			"${pageContext.request.contextPath }/customer_list_Cust_Name.action",
			{"":""},
			function(data) {
				$(data).each(function() {
...
<BODY>
	<FORM id="customerForm" name="customerForm"
		action="${pageContext.request.contextPath }/linkman_findLinkManList.action"
		method=post>
										...
										<TABLE cellSpacing=0 cellPadding=2 border=0>
											<TBODY>
												<TR>
													...
													<TD>联系人性别：</TD>
													<TD>
														<s:select list="#{'男':'男','女':'女'}" name="lkm_gender" headerKey="" headerValue="--请选择--"
														cssClass="textbox" id="sChannel2" cssStyle="WIDTH: 80px" maxLength="50"/>
													</TD>
										...
										<TABLE id=grid
											...
											<TBODY>
												...
												<TR
													...
													<TD>
													<a href="${pageContext.request.contextPath }/linkman_showEdit.action?lkm_id=${lkm_id}">修改</a>
													&nbsp;&nbsp;
													<a href="${pageContext.request.contextPath }/linkman_delete.action?lkm_id=${lkm_id}" class="confirmDel">删除</a>
													</TD>
												</TR>
												</s:iterator>
