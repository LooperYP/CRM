...
<LINK href="${pageContext.request.contextPath }/js/jqueryUi/css/smoothness/jquery-ui-1.9.2.custom.css" 
...
<script type="text/javascript">
	$(function(){
		// 使用日期控件:
		$( "#visit_begin_time" ).datepicker({ dateFormat: "yy-mm-dd" });
...
<BODY>
	<FORM id="customerForm" name="customerForm"
		action="${pageContext.request.contextPath }/saleVisit_findSaleVisitList.action"
		method=post>
										...
										<TABLE cellSpacing=0 cellPadding=2 border=0>
											<TBODY>
												<TR>
													<TD>拜访时间：</TD>
													<TD>
														<s:textfield id="visit_begin_time" name="visit_begin_time" readonly="true"
														cssStyle="WIDTH: 80px" maxLength="50" value="%{#pagination.parameterMap.visit_begin_time[0]}"/>
													</TD>
													<TD>至</TD>
													<TD>
														<s:textfield id="visit_end_time" name="visit_end_time" readonly="true"
														cssStyle="WIDTH: 80px" maxLength="50" value="%{#pagination.parameterMap.visit_end_time[0]}"/>
													</TD>
